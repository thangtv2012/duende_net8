...
namespace CoreNet8WithDuende.Pages.Admin.Clients;
...
public class ClientRepository
{
    ...
    {
        var grants = new[] { GrantType.AuthorizationCode, GrantType.ClientCredentials, GrantType.ResourceOwnerPassword };
