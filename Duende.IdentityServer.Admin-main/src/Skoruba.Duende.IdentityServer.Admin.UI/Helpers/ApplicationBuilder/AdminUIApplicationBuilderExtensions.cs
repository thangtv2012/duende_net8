...
namespace Skoruba.Duende.IdentityServer.Admin.UI.Helpers.ApplicationBuilder
{
    public static class AdminUIApplicationBuilderExtensions
    {
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseNET8Duende_SkorubaUI(this IApplicationBuilder app)
        {
        ...
        public static IEndpointConventionBuilder MapNET8Duende_SkorubaUI(this IEndpointRouteBuilder endpoint, string patternPrefix = "/")
        {
        ...
        public static IEndpointConventionBuilder MapNET8Duende_SkorubaUIHealthChecks(this IEndpointRouteBuilder endpoint, string pattern = "/health", Action<HealthCheckOptions> configureAction = null)
        {
