...
namespace Skoruba.Duende.IdentityServer.Admin.UI.Helpers.DependencyInjection
{
    public static class AdminUIServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddNET8Duende_SkorubaUI<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TAuditLogDbContext, TAuditLog, TDataProtectionDbContext>(this IServiceCollection services, Action<NET8Duende_SkorubaUIOptions> optionsAction) 
            ...
            => AddNET8Duende_SkorubaUI<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TAuditLogDbContext, TAuditLog, TDataProtectionDbContext, IdentityUser<string>, IdentityRole, IdentityUserClaim<string>,
        ...
        /// <param name="optionsAction"></param>
        /// <returns></returns>
        public static IServiceCollection AddNET8Duende_SkorubaUI<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TAuditLogDbContext, TAuditLog, TDataProtectionDbContext, TUser>(this IServiceCollection services, Action<NET8Duende_SkorubaUIOptions> optionsAction)
            ...
            where TAuditLog : AuditLog, new()
            => AddNET8Duende_SkorubaUI<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TAuditLogDbContext, TAuditLog, TDataProtectionDbContext, TUser, IdentityRole, IdentityUserClaim<string>,
                IdentityUserRole<string>, IdentityUserLogin<string>, IdentityRoleClaim<string>,
        ...
        /// <param name="optionsAction"></param>
        /// <returns></returns>
        public static IServiceCollection AddNET8Duende_SkorubaUI<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext, TLogDbContext, TAuditLogDbContext, TAuditLog, TDataProtectionDbContext, TUser, TRole, TUserClaim,
            ...
            TRoleClaimDto>
            (this IServiceCollection services, Action<NET8Duende_SkorubaUIOptions> optionsAction)
            ...
            where TAuditLog : AuditLog, new()
        {
            ...
            var options = new NET8Duende_SkorubaUIOptions();
